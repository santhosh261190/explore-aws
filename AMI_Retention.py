...
#
# This script will search for all instances having a tag with ['backupdaily', 'BackupDaily', 'backupweekly', 'BackupWeekly']
...
def lambda_handler(event, context):
    ...
    reservations = ec.describe_instances(
        Filters=[
            {'Name': 'tag-key', 'Values': ['backupdaily', 'BackupDaily', 'backupweekly', 'BackupWeekly']},
        ]
    ).get(
        'Reservations', []
    )
